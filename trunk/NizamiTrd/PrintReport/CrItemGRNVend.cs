...
namespace NizamiTrd.PrintReport {
    ...
    public class CrItemGRNVend : ReportClass {
        
        public CrItemGRNVend() {
        }
        
        public override string ResourceName {
            get {
                return "CrItemGRNVend.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "NizamiTrd.PrintReport.CrItemGRNVend.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedCrItemGRNVend : Component, ICachedReport {
        
        public CachedCrItemGRNVend() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            CrItemGRNVend rpt = new CrItemGRNVend();
            rpt.Site = this.Site;
            return rpt;
        }
