...
namespace NizamiTrd
{
    ...
    public partial class frmItemLedger : Form
    {
        ...
        private void btn_Print_Click(object sender, EventArgs e)
        {
            ...
            {
                fRptTitle = OptItemLedgerShopItem.Text;
                plstField = "@pDoc_Fiscal_ID,@pItem_ID,@pFromDate,@pToDate,@pUOMID,@pGodown";
                plstType = "8,8,18,18,8,8"; // {   "8, 8, 8, 8, 8, 8" };
                plstValue = "1," + this.msk_ItemID.Tag + "," + StrF01.D2Str(this.msk_FromDate) + "," +
                    StrF01.D2Str(this.msk_ToDate) + "," + cbo_UOM.SelectedValue.ToString()
            ...
            if (OptStockItem.Checked == true)
            {
                fRptTitle = OptStockItem.Text;
                plstField = "@pDoc_Fiscal_ID,@pFromDate,@pToDate,@pGodown,@pUOMID";
                plstType = "8,18,18,8,8"; // {   "8, 8, 8, 8, 8, 8" };
                plstValue = "1," + StrF01.D2Str(this.msk_FromDate) + "," +
                    StrF01.D2Str(this.msk_ToDate) + "," + cboGodown.SelectedValue.ToString()
            ...
            if (optSale.Checked == true)
            {
                ...
                plstField = "@pDoc_Fiscal_ID,@pFromDate,@pToDate,@pGodown,@pUOMID,@pItemID";
                plstType = "8,18,18,8,8,8"; // {   "8, 8, 8, 8, 8, 8" };
                plstValue = "1," + StrF01.D2Str(this.msk_FromDate) + "," +
                    StrF01.D2Str(this.msk_ToDate) + "," + cboGodown.SelectedValue.ToString()
                    + "," + cbo_UOM.SelectedValue.ToString()
                    + ",0";  // +msk_ItemID.ToString();
                dsItemLedger ds = new dsItemLedger();
            ...
            if (OptUnitLedgerSmry.Checked == true)
            {
                fRptTitle = "Stock Report (Godown Wise)";
                plstField = "@pDoc_Fiscal_ID,@pFromDate,@pToDate,@pGodown,@pUOMID";
                plstType = "8,18,18,8,8"; // {   "8, 8, 8, 8, 8, 8" };
                plstValue = "1," + StrF01.D2Str(this.msk_FromDate) + "," +
                    StrF01.D2Str(this.msk_ToDate) + "," + cboGodown.SelectedValue.ToString()
                    + "," + cbo_UOM.SelectedValue.ToString();
                dsItemLedger ds = new dsItemLedger();
                CrItemStockSmry rpt1 = new CrItemStockSmry();
                frmPrintViewer rptLedger = new frmPrintViewer(
                   fRptTitle,
                   this.msk_FromDate.Text,
                   this.msk_ToDate.Text,
            ...
            if (OptUnitLedgerSmryGod.Checked == true)
            {
                fRptTitle = OptUnitLedgerSmryGod.Text;
                plstField = "@pDoc_Fiscal_ID,@pFromDate,@pToDate,@pGodown,@pUOMID,@pShowZero";
                plstType = "8,18,18,8,8,8"; // {   "8, 8, 8, 8, 8, 8" };
                plstValue = "1," + StrF01.D2Str(this.msk_FromDate) + "," +
                    StrF01.D2Str(this.msk_ToDate) + "," + cboGodown.SelectedValue.ToString()
                    + "," + cbo_UOM.SelectedValue.ToString()
                    +"," + (chkShowZeroBal.Checked==true ? 0 : 1) ;
                dsItemLedger ds = new dsItemLedger();
                CrItemStockSmryGod rpt1 = new CrItemStockSmryGod();
                frmPrintViewer rptLedger = new frmPrintViewer(
                   fRptTitle,
                   this.msk_FromDate.Text,
                   this.msk_ToDate.Text,
                   "sp_Item_StockSmryGod",
                   plstField,
                   plstType,
                   plstValue,
                   ds,
            ...
            {
                fRptTitle = OptItemLedgerShop.Text;
                plstField = "@pDoc_Fiscal_ID,@pFromDate,@pToDate,@pGodown";
                plstType = "8,18,18,8"; // {   "8, 8, 8, 8, 8, 8" };
                plstValue = "1," + StrF01.D2Str(this.msk_FromDate) + "," +
                    StrF01.D2Str(this.msk_ToDate) + "," + cboGodown.SelectedValue.ToString();
            ...
            {
                fRptTitle = OptUnitLedger.Text;
                plstField = "@pDoc_Fiscal_ID,@pFromDate,@pToDate,@pGodown";
                plstType = "8,18,18,8"; // {   "8, 8, 8, 8, 8, 8" };
                plstValue = "1," + StrF01.D2Str(this.msk_FromDate) + "," +
                    StrF01.D2Str(this.msk_ToDate) + "," + cboGodown.SelectedValue.ToString();
                dsItemLedger ds = new dsItemLedger();
                CrItemStokLedgerPT rpt1 = new CrItemStokLedgerPT();
                //CrItemStokLedger rpt1 = new CrItemStokLedger();
                frmPrintViewer rptLedger = new frmPrintViewer(
                   fRptTitle,
                   this.msk_FromDate.Text,
            ...
            if (optSalePoint.Checked == true)
            {
                ...
                frmPrintViewerSub4Rpt rptLedger = new frmPrintViewerSub4Rpt(
                   "Daily Summary",
                   this.msk_FromDate.Text,
                   this.msk_ToDate.Text,
                   "sp_SalePoint",
        ...
        private void OptStockItem_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void OptUnitLedgerSmry_CheckedChanged(object sender, EventArgs e)
        {
