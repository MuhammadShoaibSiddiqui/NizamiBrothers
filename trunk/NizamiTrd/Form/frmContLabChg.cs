...
namespace NizamiTrd
{
    ...
    public partial class frmContLabChg : Form
    {
        ...
        int fDocTypeID = clsGVar.CLC;                         // Voucher/Doc Type ID
        ...
        private void LoadInitialControls()
        {
            ...
            string IColWidth = "";
            IColWidth +=  "5".ToString();    //"ItemID";                       // 0-   Hiden
            IColWidth +=  ",15".ToString();    //",Item Name";                      // 1-   Hiden
            IColWidth +=   ",3".ToString();    //",UOM ID";                          // 2-   
            IColWidth +=  ",10".ToString();      //",UOM Name";                          // 3-   
            IColWidth +=  ",9".ToString();    //",Waste %Age";                          // 4-   
            IColWidth +=   ",9".ToString();    //",Rate";                          // 5-   
            IColWidth +=   ",9".ToString();    //",Mfg. Qty";                          // 6-   
            IColWidth +=   ",9".ToString();    //",Mesh Rate";                          // 7-   
            IColWidth +=   ",9".ToString();   //",Mfg.Mesh Qty";                          // 8-   

            string IColMinWidth = "";
            IColMinWidth +=  "0".ToString();     //"ItemID";                       // 0-   Hiden
            IColMinWidth +=  ",0".ToString();     //",Item Name";                      // 1-   Hiden
            IColMinWidth +=   ",0".ToString();     //",UOM ID";                          // 2-   
            IColMinWidth +=  ",0".ToString();      //",UOM Name";                          // 3-   
            IColMinWidth +=  ",0".ToString();     //",Waste %Age";                          // 4-   
            IColMinWidth +=   ",0".ToString();    //",Rate";                          // 5-   
            IColMinWidth +=   ",0".ToString();    //",Mfg. Qty";                          // 6-   
            IColMinWidth +=   ",0".ToString();    //",Mesh Rate";                          // 7-   
            IColMinWidth +=   ",0".ToString();    //",Mfg.Mesh Qty";                          // 8-   

            string IColMaxWidth = "";
            IColMaxWidth +=  "5".ToString();      //"ItemID";                       // 0-   Hiden
            IColMaxWidth +=  ",15".ToString();     //",Item Name";                      // 1-   Hiden
            IColMaxWidth +=   ",3".ToString();     //",UOM ID";                          // 2-   
            IColMaxWidth +=  ",10".ToString();      //",UOM Name";                          // 3-   
            IColMaxWidth +=  ",9".ToString();     //",Waste %Age";                          // 4-   
            IColMaxWidth +=   ",9".ToString();    //",Rate";                          // 5-   
            IColMaxWidth +=   ",9".ToString();    //",Mfg. Qty";                          // 6-   
            IColMaxWidth +=   ",9".ToString();    //",Mesh Rate";                          // 7-   
            IColMaxWidth +=   ",9".ToString();    //",Mfg.Mesh Qty";                          // 8-               

            string IColFormat = "";
            IColFormat += "T";                       // 0-   Hiden
            IColFormat += ",T";                      // 1-   Hiden
            IColFormat += ",H";                          // 2-   
            IColFormat += ",T";                          // 3-   
            IColFormat += ",N2";                          // 4-   
            IColFormat += ",N2";                          // 5-   
            ...
            string IColReadOnly = "";
            IColReadOnly +=   "1".ToString();      //"ItemID";                       // 0-   Hiden
            IColReadOnly +=  ",1".ToString();     //",Item Name";                      // 1-   Hiden
            IColReadOnly +=  ",1".ToString();     //",UOM ID";                          // 2-   
            IColReadOnly +=  ",1".ToString();      //",UOM Name";                          // 3-   
            IColReadOnly +=  ",1".ToString();     //",Waste %Age";                          // 4-   
            IColReadOnly +=  ",1".ToString();    //",Rate";                          // 5-   
            IColReadOnly +=  ",1".ToString();    //",Mfg. Qty";                          // 6-   
            IColReadOnly +=  ",1".ToString();    //",Mesh Rate";                          // 7-   
            IColReadOnly += ",1".ToString();    //",Mfg.Mesh Qty";                          // 8-   
            ...
            clsDbManager.SetGridHeaderCmb(
                ...
                false,
                2);
            //grdVoucher.Columns[(int)GColCLC.WidDec].MinimumWidth = 20;
        ...
        private void LookUpAc_Mask()
         {
            ...
            //and a.ac_id IN (SELECT Godown_ac_id FROM cmn_Godown)
        ...
        private void btn_Add_Click(object sender, EventArgs e)
        {
            if (btn_Add.Text.ToString() == "&Add")
            {
                ...
                grdVoucher.Rows.Add(txtItemID.Text.ToString(),
                    ...
                    txtMeshQty.Text.ToString(),
                    txtMeshRate.Text.ToString()
            ...
            {
                grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.ItemID].Value=txtItemID.Text;
                grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.ItemName].Value=lblItemName.Text;
                grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.UOMID].Value = cbo_UOM.SelectedValue.ToString();
                grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.UOMName].Value = cbo_UOM.Text;
                //grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.GodownID].Value = cboGodown.SelectedValue.ToString();
                //grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.GodownName].Value = cboGodown.Text;
                
                grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.WastPAge].Value=txtQty.Text.ToString();
                grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.Rate].Value=txtRate.Text.ToString();
                grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.MfgQty].Value = txtMeshQty.Text.ToString();
                grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.MeshRate].Value = txtMeshRate.Text.ToString();
                grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.MfgMeshQty].Value = 0; //txtMeshQty.Text.ToString();

                //grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.Bundle].Value=txtBundle.Text.ToString();
                //grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.MeshTotal].Value=lblTotalMeasure.Text.ToString();
                //grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.Amount].Value=lblAmount.Text.ToString();

                //grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.Length].Value=txtLength.Text.ToString();
                //grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.LenDec].Value=txtLenDec.Text.ToString();
                //grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.Width].Value=txtWidth.Text.ToString();
                //grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.WidDec].Value=txtWidDec.Text.ToString();
                //grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.isBundle].Value = (chk_BundleCalc.Checked == true ? 1 : 0);
                //grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.isMesh].Value = (chk_Mesh.Checked == true ? 1 : 0);
        ...
        private void SumVoc()
        {
            ...
            //{
                // isBundle Check
                //if (grdVoucher.Rows[i].Cells[(int)GColCLC.isBundle].Value == null)
                //{
                //    str_IsBundle = clsDbManager.ConvBit("False");
                //}
                //else
                //{
                //    str_IsBundle = clsDbManager.ConvBit(grdVoucher.Rows[i].Cells[(int)GColCLC.isBundle].Value.ToString());
                //}

                // isMesh Check
                //if (grdVoucher.Rows[i].Cells[(int)GColCLC.isMesh].Value == null)
                //{
                //    str_IsMesh = clsDbManager.ConvBit("False");
                //}
                //else
                //{
                //    str_IsMesh = clsDbManager.ConvBit(grdVoucher.Rows[i].Cells[(int)GColCLC.isMesh].Value.ToString());
                //}

                //if (str_IsBundle == "1")
                //{
                //    grdVoucher.Rows[i].Cells[(int)GColCLC.Amount].Value =
                //        clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColCLC.Rate].Value.ToString())
                //        * clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColCLC.MeshQty].Value.ToString());
                //}
                ...
                //        clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColCLC.Rate].Value.ToString())
                //        * clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColCLC.MeshQty].Value.ToString())
                //        * (clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColCLC.Width].Value.ToString())
                //         + ((clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColCLC.WidDec].Value.ToString())) * clsDbManager.ConvDecimal("0.0833")))
                //        * (clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColCLC.Length].Value.ToString())
                //         + ((clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColCLC.LenDec].Value.ToString())) * clsDbManager.ConvDecimal("0.0833")))
                //        ;
                ...
                //    grdVoucher.Rows[i].Cells[(int)GColCLC.Amount].Value =
                //        clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColCLC.Rate].Value.ToString())
                //        * clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColCLC.WastPAge].Value.ToString());
                ...
                //if (grdVoucher.Rows[i].Cells[(int)GColCLC.Amount].Value != null)
                //{
                //    bcheck = decimal.TryParse(grdVoucher.Rows[i].Cells[(int)GColCLC.Amount].Value.ToString(), out outValue);
                //    if (bcheck)
                //    {
                //        rtnVal += outValue;
                //        fTotalAmount += outValue;
                //        fTotalQty += clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColCLC.WastPAge].Value.ToString());
                //    }
                //}
        ...
        //    for (int i = 0; i < grdVoucher.RowCount; i++)
        //    {
        //            grdVoucher.Rows[i].Cells[(int)GColCLC.GodownID].Value = pGodown_ID;
        //    }
        //}
        ...
        private bool PrepareDocMaster()
        {
            ...
            try
            {
                ...
                if (lblDocID.Text.ToString().Trim(' ', '-') == "")
                {
                    ...
                    fDocID = clsDbManager.GetNextValDocID("ct_tran", "doc_id", fDocWhere, "");
                    ...
                    lSQL += ",'" + StrF01.EnEpos(txtRemarks.Text.ToString()) + "'"; // 8-
                    lSQL += ", " + fDocAmt.ToString();                              // 9-
                    lSQL += ", " + clsDbManager.ConvBit(chkComplete);                               // 13- Doc Status 
                ...
                else
                {
                    ...
                    if (clsDbManager.IDAlreadyExistWw("ct_tran", "doc_id", fDocWhere))
                    {
                    ...
                    //{
                        ...
                        lSQL += ", doc_remarks = '" + StrF01.EnEpos(txtRemarks.Text.ToString()) + "'";    // 12-
                        lSQL += ", doc_amt = " + fDocAmt.ToString();                                // 13-
                        lSQL += ", doc_Status = " + clsDbManager.ConvBit(chkComplete);
        ...
        private bool PrepareDocDetail()
        {
            ...
            try
            {
                ...
                if (grdVoucher.Rows.Count > 0)
                {
                    ...
                    tColType += ", N2";  //4 Waste%age      
                    tColType += ", N2";  //5 Rate
                    tColType += ", N2";  //6 MfgQty      
                    tColType += ", N2";  //7 Mesh Rate
                    tColType += ", N2";  //8 Mesh MfgQty      
                    //
                    ...
                    tFieldName += ", WastePAge";           //4 
                    tFieldName += ", Rate";          //5  
                    tFieldName += ", MfgQty";       //6  
                    tFieldName += ", MeshRate";      //7  
                    tFieldName += ", MeshQty";       //8 
                    // 
        ...
        { 
            ...
            try
            {
                ...
                for (int dGVRow = 0; dGVRow < grdVoucher.Rows.Count; dGVRow++)
                {
                    ...
                    //
                    if (grdVoucher.Rows[dGVRow].Cells[(int)GColCLC.ItemID].Value == null)
                    {
                        if (dGVRow == fLastRow)
                        {
                            continue;
                    ...
                    {
                        if ((grdVoucher.Rows[dGVRow].Cells[(int)GColCLC.ItemID].Value.ToString()).Trim(' ', '-') == "")
                        {
                            //lBlank = true;
                            if (dGVRow == fLastRow)
                            {
                    ...
                    lSQL += " WHERE i.goodsitem_id=" + grdVoucher.Rows[dGVRow].Cells[(int)GColCLC.ItemID].Value.ToString();
                    lSQL += "; SELECT goodsuom_st FROM gds_uom WHERE goodsuom_id=";
                    lSQL += grdVoucher.Rows[dGVRow].Cells[(int)GColCLC.UOMID].Value.ToString();
                    ...
                    //if (grdVoucher.Rows[dGVRow].Cells[(int)GColCLC.isMesh].Value != null)
                    //{
                    //    if (clsDbManager.ConvBit(grdVoucher.Rows[dGVRow].Cells[(int)GColCLC.isBundle].Value.ToString()) == "0"
                    //        && clsDbManager.ConvBit(grdVoucher.Rows[dGVRow].Cells[(int)GColCLC.isMesh].Value.ToString()) == "0")
                    //    {
                    //        strItemDes += " B=" + grdVoucher.Rows[dGVRow].Cells[(int)GColCLC.MeshQty].Value.ToString()
                    //            + " Q=" + grdVoucher.Rows[dGVRow].Cells[(int)GColCLC.WastPAge].Value.ToString()
                    //            + " " + strUOM_ST
                    //            + " @" + grdVoucher.Rows[dGVRow].Cells[(int)GColCLC.Rate].Value.ToString();
                    //    }

                        //if (clsDbManager.ConvBit(grdVoucher.Rows[dGVRow].Cells[(int)GColCLC.isBundle].Value.ToString()) == "1")
                        //{
                        //    strItemDes += " Q=" + grdVoucher.Rows[dGVRow].Cells[(int)GColCLC.MeshQty].Value.ToString()
                        //        + " " + strUOM_ST
                        //        + " @" + grdVoucher.Rows[dGVRow].Cells[(int)GColCLC.Rate].Value.ToString();
                        //}

                        //if (clsDbManager.ConvBit(grdVoucher.Rows[dGVRow].Cells[(int)GColCLC.isMesh].Value.ToString()) == "1")
                        //{
                        //    strItemDes += " B=" + grdVoucher.Rows[dGVRow].Cells[(int)GColCLC.MeshQty].Value.ToString()
                        //        + " x L=" + grdVoucher.Rows[dGVRow].Cells[(int)GColCLC.Length].Value.ToString()
                        //        + " x W=" + grdVoucher.Rows[dGVRow].Cells[(int)GColCLC.Width].Value.ToString()
                        //        + " Q=" + grdVoucher.Rows[dGVRow].Cells[(int)GColCLC.MeshRate].Value.ToString()
                        //        + " " + strUOM_ST
                        //        + " @" + grdVoucher.Rows[dGVRow].Cells[(int)GColCLC.Rate].Value.ToString();
                        //}
        ...
        private int GridTNOT(DataGridView pdGv)
        {
            ...
            try
            {
                ...
                for (int dGVRow = 0; dGVRow < pdGv.Rows.Count; dGVRow++)
                {
                    ...
                    // Prepare Save Data to Db Table
                    //
                    //if (pdGv.Rows[dGVRow].Cells[(int)GColCLC.ItemID].Value == null)
                    //{
                    //    if (dGVRow == fLastRow)
                    //    {
                    //        break;
                    ...
                    //else
                    //{
                    //    if ((pdGv.Rows[dGVRow].Cells[(int)GColCLC.ItemID].Value.ToString()).Trim(' ', '-') == "")
                    //    {
                    //        //lBlank = true;
                    //        if (dGVRow == fLastRow)
                    //        {
        ...
        private void LookUp_Voc()
        {
            ...
            frmLookUp sForm = new frmLookUp(
                    ...
                    true,
                    "",
                    "doc_vt_id = " + fDocTypeID.ToString() + " and doc_fiscal_id = 1",
                    "TextBox"
                    );
             //and doc_status = 1
        ...
        private void PopulateRecords()
        {
            ...
            tSQL += " it.doc_amt, it.Doc_Status, it.GLID, ga.ac_title, ga.ac_strid, ";
            ...
            tSQL += " where  it.doc_vt_id=" + fDocTypeID.ToString() + " and it.doc_fiscal_id=1";
        ...
        private void ClearSub_Add_Btn()
        {
            ...
            txtMeshQty.Text = string.Empty;
            txtMeshRate.Text = string.Empty;
        ...
        private void LoadGridData() 
        {
          ...
          lSQL += ", td.MfgQty";                                               // 6-
          lSQL += ", td.MeshRate";                                          // 7-
          lSQL += ", isNull(td.MfgMeshQty,0) as MfgMeshQty";                                               // 6-
          ...
          //lSQL += " ELSE 0 END as Amount";
          ////lSQL += " ELSE isNull(td.Rate,0)*isNull(td.Qty,0) END as Amount";
          ...
          //lSQL += ", td.WidDec";           //16
          //
          lSQL += " FROM ct_tran t INNER JOIN ct_trandtl td  ON t.doc_vt_id=td.doc_vt_id ";
          ...
          tFieldList += ", WastePAge";           // 4
          tFieldList += ", Rate";              //5
          tFieldList += ", MfgQty";            //6
          tFieldList += ", MeshRate";         //7
          tFieldList += ", MfgMeshQty";            //8
          // 
          string tColFormat = "N0";
          tColFormat  =  "N0";                                                    // 0-    Item ID
          tColFormat += ",TB";                                                    // 1-    Name
          tColFormat += ",N0";                                                    // 2- UOM
          tColFormat += ",TB";                                                    // 3- UOM Name
          tColFormat += ",N2";                                                    // 4-    %age
          tColFormat += ",N2";                                                    // 5-  Rate
          tColFormat += ",N2";                                                    // 6-  Mfg Qty
          tColFormat += ",N2";                                                    // 7- Mesh Rate
          tColFormat += ",N2";                                                    // 8- Mfg Mesh Qty
        ...
        private void grdVoucher_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Space)
            {
                ...
                if (grdVoucher.Rows.Count > 0)
                {
                    ...
                    txtItemID.Text = grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.ItemID].Value.ToString();
                    lblItemName.Text = grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.ItemName].Value.ToString();
                    cbo_UOM.SelectedIndex = clsSetCombo.Set_ComboBox(cbo_UOM, int.Parse(grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.UOMID].Value.ToString()));
                    //cboGodown.SelectedIndex = clsSetCombo.Set_ComboBox(cboGodown, int.Parse(grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.GodownID].Value.ToString()));

                    txtQty.Text = grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.WastPAge].Value.ToString();
                    txtRate.Text = grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.Rate].Value.ToString();
                    txtMeshQty.Text = grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.MfgQty].Value.ToString();
                    txtMeshRate.Text = grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.MeshRate].Value.ToString();
                    txtMeshQty.Text = grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.MfgMeshQty].Value.ToString();

                    //lblAmount.Text = grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.Amount].Value.ToString();
                    //txtLength.Text = grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.Length].Value.ToString();
                    //txtLenDec.Text = grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.LenDec].Value.ToString();
                    //txtWidth.Text = grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.Width].Value.ToString();
                    //txtWidDec.Text = grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.WidDec].Value.ToString();

                    //ConvBit(pdGv.Rows[i].Cells[j].Value.ToString())
                    //if (grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.isBundle].Value.ToString() == "True")
                    //{
                    //    chk_BundleCalc.Checked = true;
                    //}
                    //if (grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.isMesh].Value.ToString() == "True")
                    //{
                    //    chk_Mesh.Checked = true;
                    //}

                    //chk_BundleCalc.Checked = clsDbManager.ConvBit(grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.isBundle].Value.ToString());
                    //chk_Mesh.Checked = grdVoucher.Rows[fEditRow].Cells[(int)GColCLC.isMesh].Value.ToString();
        ...
        private void btn_View_Click(object sender, EventArgs e)
        {
            ...
            CrContract rpt1 = new CrContract();
        ...
        private bool ValidationAdd_Btn() 
        {
            ...
            try
            {
                ...
                {
                    ErrrMsg = StrF01.BuildErrMsg(ErrrMsg, "'" + "Item Waste %Age Empty or Blank, Put the Waste %Age and Try Again");
                    fTErr++;
                    lRtnValue = false;
                    txtQty.Focus();
                }
