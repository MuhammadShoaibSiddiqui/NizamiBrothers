...
using NizamiTrd.PrintViewer6p;
//using NizamiTrd.Form;
...
namespace NizamiTrd
{
    ...
    public partial class frmPeriodGroup : Form
    {
        public frmPeriodGroup()
        {
            InitializeComponent();
            //msk_FromDate.Text = cnstFromDate;
        }
        ...
        private void SumLedger()
        {
            ...
            {
                colDebit += clsDbManager.ConvDecimal(grdDetail.Rows[i].Cells[(int)grdGT.DrCol].Value.ToString());
                colCredit += clsDbManager.ConvDecimal(grdDetail.Rows[i].Cells[(int)grdGT.CrCol].Value.ToString());
                grdDetail.Rows[i].Cells[(int)grdGT.BalCol].Value = clsDbManager.ConvDecimal(lblOpBal.Text) + colDebit - colCredit;
        ...
        {
            if (optBal.Checked == true)
            {
                string fRptTitle = "Period Wise Report";
                ...
                CrPeriodGrp2 rpt1 = new CrPeriodGrp2();
                //CrPeriodGroup rpt1 = new CrPeriodGroup();
            ...
            if (optWithoutOpBal.Checked == true)
            {
                string fRptTitle = "Period Wise Report";
                string plstField = "@pDoc_Fiscal_ID,@pAc_ID,@pFromDate,@pToDate";
                string plstType = "8,8,18,18"; // {   "8, 8, 8, 8, 8, 8" };
                ...
                dsPeriodGroup ds = new dsPeriodGroup();
                CrPeriodGrpWOOP rpt1 = new CrPeriodGrpWOOP();
            ...
            if (OptTrial.Checked == true)
            {
                string fRptTitle = "Trial Balance";
                //string fRptTitle = this.Text;
                string plstField = "@pDoc_Fiscal_ID,@pFromDate,@pToDate";
                string plstType = "8,18,18"; // {   "8, 8, 8, 8, 8, 8" };
                string plstValue = "1," + StrF01.D2Str(this.msk_FromDate) + "," +
                    StrF01.D2Str(this.msk_ToDate);
            ...
            if (OptTrialOp.Checked == true)
            {
                string fRptTitle = "Trial Balance With Opening";
                //string fRptTitle = this.Text;
                string plstField = "@pDoc_Fiscal_ID,@pFromDate,@pToDate";
                string plstType = "8,18,18"; // {   "8, 8, 8, 8, 8, 8" };
                string plstValue = "1," + StrF01.D2Str(this.msk_FromDate) + "," +
            ...
            if (OptTrialComplete.Checked == true)
            {
                string fRptTitle = "Trial Balance Complete";
                //string fRptTitle = this.Text;
                string plstField = "@pDoc_Fiscal_ID,@pFromDate,@pToDate";
                string plstType = "8,18,18"; // {   "8, 8, 8, 8, 8, 8" };
                string plstValue = "1," + StrF01.D2Str(this.msk_FromDate) + "," +
                ...
                dsPeriodGroup ds = new dsPeriodGroup();
                CrTrialComplete rpt1 = new CrTrialComplete();
            ...
            if (OptTrialGroup.Checked == true)
            {
                string fRptTitle = "Trial Balance Group Wise";
                //string fRptTitle = this.Text;
                string plstField = "@pDoc_Fiscal_ID,@pFromDate,@pToDate";
                string plstType = "8,18,18"; // {   "8, 8, 8, 8, 8, 8" };
                string plstValue = "1," + StrF01.D2Str(this.msk_FromDate) + "," +
                ...
                dsPeriodGroup ds = new dsPeriodGroup();
                CrTrialGroup rpt1 = new CrTrialGroup();
            ...
            if (optCOA_Addr.Checked == true)
            {
                if (this.msk_AccountID.Tag==null)
                {
                    this.msk_AccountID.Tag = 0;
                }
                string fRptTitle = "Chart of Accounts (Address) Report";
                string plstField = "@pDoc_Fiscal_ID,@pAc_ID";
                string plstType = "8,8"; // {   "8, 8, 8, 8, 8, 8" };
                string plstValue = "1," + this.msk_AccountID.Tag;

                dsCOA_Addr ds = new dsCOA_Addr();
                CrCOA_Addr rpt1 = new CrCOA_Addr();
            ...
            if (optCustAddr.Checked == true)
            {
                ...
                dsCOA_Addr ds = new dsCOA_Addr();
                CrCOA_Envelop rpt1 = new CrCOA_Envelop();
            ...
            if (optCOA.Checked == true)
            {
                string fRptTitle = "Chart of Accounts";
                string plstField = "@pDoc_Fiscal_ID";
                string plstType = "8"; // {   "8, 8, 8, 8, 8, 8" };
                string plstValue = "1";

                dsAgingDue ds = new dsAgingDue();
                CrCOA rpt1 = new CrCOA();
            ...
            if (optCOA_Group.Checked == true)
            {
                string fRptTitle = "Chart of Accounts (Group)";
                string plstField = "@pDoc_Fiscal_ID,@isTran";
                string plstType = "8,8"; // {   "8, 8, 8, 8, 8, 8" };
                string plstValue = "1,0";
            ...
            if (optCOA_Detail.Checked == true)
            {
                string fRptTitle = "Chart of Accounts (Detail)";
                string plstField = "@pDoc_Fiscal_ID,@isTran";
                string plstType = "8,8"; // {   "8, 8, 8, 8, 8, 8" };
                string plstValue = "1,1";
            ...
            {
                string fRptTitle = "Period Wise Comparison Report";
                //string fRptTitle = this.Text;
                string plstField = "@pDoc_Fiscal_ID,@pAc_ID,@pFromDate,@pToDate";
                string plstType = "8,8,18,18"; // {   "8, 8, 8, 8, 8, 8" };
                string plstValue = "1," + this.msk_AccountID.Tag + "," + StrF01.D2Str(this.msk_FromDate) + "," +
                ...
                dsPeriodGroup ds = new dsPeriodGroup();
                CrPeriodGroupBal rpt1 = new CrPeriodGroupBal();
            ...
            if (OptCompBal.Checked == true)
            {
                ...
                dsPeriodGroup ds = new dsPeriodGroup();
                CrMonthlyCompSum rpt1 = new CrMonthlyCompSum();
