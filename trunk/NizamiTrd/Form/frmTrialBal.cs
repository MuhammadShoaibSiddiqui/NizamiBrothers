...
namespace NizamiTrd
{
    ...
    private void pnlCalander_Paint(object sender, PaintEventArgs e)
    {
        msk_FromDate.Text = mCalendarMain.SelectionStart.ToString();
    }
    ...
    private void frmTrialBal_Load(object sender, EventArgs e)
    {
    ...
    private void btn_FromDate_Click_1(object sender, EventArgs e)
    {
        if (pnlCalander.Visible)
        {
            pnlCalander.Visible = false;
