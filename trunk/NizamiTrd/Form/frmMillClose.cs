...
namespace NizamiTrd
{
    ...
    public partial class frmMillClose : Form
    {
        ...
        int fDocTypeID = clsGVar.MLC;                         // Voucher/Doc Type ID
        ...
        private void LoadInitialControls()
        {
            ...
            clsDbManager.SetGridHeaderCmb(
                ...
                false,
                2);
            grdVoucher.Columns[(int)GColMill.Amount].MinimumWidth = 100;
        ...
        private void LoadInitialControlsWaste()
        {
            ...
            clsDbManager.SetGridHeaderCmb(
                ...
                false,
                2);
            grdWaste.Columns[(int)GColWasteMill.WidDec].MinimumWidth = 20;
        }
        ...
        private void btn_Add_Click(object sender, EventArgs e)
        {
            ...
            {
                grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.ItemID].Value = txtItemID.Text;
                grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.ItemName].Value = lblItemName.Text;
                grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.UOMID].Value = cbo_UOM.SelectedValue.ToString();
                grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.UOMName].Value = cbo_UOM.Text;
                grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.GodownID].Value = cboGodown.SelectedValue.ToString();
                grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.GodownName].Value = cboGodown.Text;

                grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.Qty].Value = txtQty.Text.ToString();
                grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.Rate].Value = txtRate.Text.ToString();
                grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.Bundle].Value = txtBundle.Text.ToString();
                grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.MeshTotal].Value = lblTotalMeasure.Text.ToString();
                grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.Amount].Value = lblAmount.Text.ToString();

                grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.Length].Value = txtLength.Text.ToString();
                grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.LenDec].Value = txtLenDec.Text.ToString();
                grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.Width].Value = txtWidth.Text.ToString();
                grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.WidDec].Value = txtWidDec.Text.ToString();
                grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.isBundle].Value = (chk_BundleCalc.Checked == true ? 1 : 0);
                grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.isMesh].Value = (chk_Mesh.Checked == true ? 1 : 0);
        ...
        private void SumVoc()
        {
            ...
            {
                grdVoucher.Rows[i].Cells[(int)GColMill.WstableQty].Value =
                    clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColMill.TotalOutput].Value.ToString())
                    - clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColMill.WstLessQty].Value.ToString());

                grdVoucher.Rows[i].Cells[(int)GColMill.WstQty].Value =
                    ((clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColMill.WstableQty].Value.ToString()) 
                    / (100-clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColMill.WstPAge].Value.ToString()))) * 100) 
                    - clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColMill.WstableQty].Value.ToString());

                //grdVoucher.Rows[i].Cells[(int)GColMill.WstQty].Value =
                //    (clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColMill.WstableQty].Value.ToString())
                //    * clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColMill.WstPAge].Value.ToString()))/100;

                grdVoucher.Rows[i].Cells[(int)GColMill.LabChgableQty].Value =
                    clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColMill.TotalOutput].Value.ToString())
                    - clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColMill.WOLabQty].Value.ToString());

                grdVoucher.Rows[i].Cells[(int)GColMill.LabChg].Value =
                    clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColMill.LabRate].Value.ToString())
                    * clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColMill.LabChgableQty].Value.ToString());

                grdVoucher.Rows[i].Cells[(int)GColMill.Amount].Value =
                    clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColMill.MeshRate].Value.ToString())
                    * clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColMill.MeshTotal].Value.ToString());

                fWasteQty += clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColMill.WstQty].Value.ToString());
                fWasteableQty += clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColMill.WstableQty].Value.ToString());
                fLabChges += clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColMill.LabChg].Value.ToString());
                fTotalAmount += clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColMill.Amount].Value.ToString());

                fTotalQtyIn += clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColMill.QtyIn].Value.ToString());
                fTotalQtyOut += clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColMill.QtyOut].Value.ToString());
                fTotalBal += clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColMill.TotalOutput].Value.ToString());
                if (clsDbManager.ConvDecimal(grdVoucher.Rows[i].Cells[(int)GColMill.LabRate].Value.ToString()) == 0)
                {
        ...
        private void SumWaste()
        {
            ...
            {
                // isBundle Check
                if (grdWaste.Rows[i].Cells[(int)GColWasteMill.isBundle].Value == null)
                {
                    str_IsBundle = clsDbManager.ConvBit("False");
                }
                else
                {
                    str_IsBundle = clsDbManager.ConvBit(grdWaste.Rows[i].Cells[(int)GColWasteMill.isBundle].Value.ToString());
                }

                // isMesh Check
                if (grdWaste.Rows[i].Cells[(int)GColWasteMill.isMesh].Value == null)
                {
                    str_IsMesh = clsDbManager.ConvBit("False");
                }
                else
                {
                    str_IsMesh = clsDbManager.ConvBit(grdWaste.Rows[i].Cells[(int)GColWasteMill.isMesh].Value.ToString());
                }

                if (str_IsBundle == "1")
                {
                    grdWaste.Rows[i].Cells[(int)GColWasteMill.Amount].Value =
                        clsDbManager.ConvDecimal(grdWaste.Rows[i].Cells[(int)GColWasteMill.Rate].Value.ToString())
                        * clsDbManager.ConvDecimal(grdWaste.Rows[i].Cells[(int)GColWasteMill.Bundle].Value.ToString());
                }
                ...
                if (str_IsMesh == "1")
                {
                    grdWaste.Rows[i].Cells[(int)GColWasteMill.Amount].Value =
                        clsDbManager.ConvDecimal(grdWaste.Rows[i].Cells[(int)GColWasteMill.Rate].Value.ToString())
                        * clsDbManager.ConvDecimal(grdWaste.Rows[i].Cells[(int)GColWasteMill.Bundle].Value.ToString())
                        * (clsDbManager.ConvDecimal(grdWaste.Rows[i].Cells[(int)GColWasteMill.Width].Value.ToString())
                         + ((clsDbManager.ConvDecimal(grdWaste.Rows[i].Cells[(int)GColWasteMill.WidDec].Value.ToString())) * clsDbManager.ConvDecimal("0.0833")))
                        * (clsDbManager.ConvDecimal(grdWaste.Rows[i].Cells[(int)GColWasteMill.Length].Value.ToString())
                         + ((clsDbManager.ConvDecimal(grdWaste.Rows[i].Cells[(int)GColWasteMill.LenDec].Value.ToString())) * clsDbManager.ConvDecimal("0.0833")))
                        ;
                ...
                if (str_IsBundle == "0" && str_IsMesh == "0")
                {
                    grdWaste.Rows[i].Cells[(int)GColWasteMill.Amount].Value =
                        clsDbManager.ConvDecimal(grdWaste.Rows[i].Cells[(int)GColWasteMill.Rate].Value.ToString())
                        * clsDbManager.ConvDecimal(grdWaste.Rows[i].Cells[(int)GColWasteMill.Qty].Value.ToString());
                ...
                if (grdWaste.Rows[i].Cells[(int)GColWasteMill.Amount].Value != null)
                {
                    bcheck = decimal.TryParse(grdWaste.Rows[i].Cells[(int)GColWasteMill.Amount].Value.ToString(), out outValue);
                    if (bcheck)
                    {
                        rtnVal += outValue;
                        fTotalAmount += outValue;
                        fTotalQty += clsDbManager.ConvDecimal(grdWaste.Rows[i].Cells[(int)GColWasteMill.Qty].Value.ToString());
                    }
                }
...
// Invoice Data Update
        ...
        private bool PrepareDocGLDetail()
        {
            ...
            try
            {
                ...
                {
                    if (clsDbManager.ConvDecimal(grdVoucher.Rows[dGVRow].Cells[(int)GColMill.LabChg].Value.ToString()) != 0)
                    {
                        lSQL = "insert into gl_trandtl ( ";
                        // Middle Pottion
                        lSQL += " doc_vt_id ";                                                               // Form 1- 
                        ...
                        //                                                                                       // 5- Ac Title NA
                        lSQL += ", '" + StrF01.EnEpos(grdVoucher.Rows[dGVRow].Cells[(int)GColMill.ItemName].Value.ToString()) 
                             + " Qty: " + StrF01.EnEpos(grdVoucher.Rows[dGVRow].Cells[(int)GColMill.LabChgableQty].Value.ToString())
                            + "@" + String.Format("{0:0,0.00}", grdVoucher.Rows[dGVRow].Cells[(int)GColMill.LabRate].Value)
                            + "'";      // 8- Narration 
                        ...
                        if (clsDbManager.ConvDecimal(grdVoucher.Rows[dGVRow].Cells[(int)GColMill.LabChg].Value.ToString()) > 0)
                        {
                            lSQL += ", " + grdVoucher.Rows[dGVRow].Cells[(int)GColMill.LabChg].Value.ToString();           // 9- Debit. 
                            lSQL += ", 0";          // 10- Credit
                        }
                        if (clsDbManager.ConvDecimal(grdVoucher.Rows[dGVRow].Cells[(int)GColMill.LabChg].Value.ToString()) < 0)
                        {
                            lSQL += ", 0";            // 9- Debit. 
                            lSQL += ", " + Math.Abs(clsDbManager.ConvDecimal(grdVoucher.Rows[dGVRow].Cells[(int)GColMill.LabChg].Value.ToString()));  //grdVoucher.Rows[dGVRow].Cells[(int)GColMfg.LabChg].Value.ToString();           // 10- Credit
                        }
                        ...
                        //                                                                                       // 5- Ac Title NA
                        lSQL += ", '" + StrF01.EnEpos(grdVoucher.Rows[dGVRow].Cells[(int)GColMill.ItemName].Value.ToString())       // 8- Narration 
                            + " Qty: " + StrF01.EnEpos(grdVoucher.Rows[dGVRow].Cells[(int)GColMill.LabChgableQty].Value.ToString())
                            + "@" + String.Format("{0:0,0.00}", grdVoucher.Rows[dGVRow].Cells[(int)GColMill.LabRate].Value)
                            //+ "@" + String.Format("{0:0,0.00}", StrF01.EnEpos(grdVoucher.Rows[dGVRow].Cells[(int)GColMfg.LabRate].Value.ToString()))
                            + "'";      // 8- Narration 
                ...
                {
                    if (clsDbManager.ConvDecimal(grdWaste.Rows[dGVRow].Cells[(int)GColWasteMill.ItemID].Value.ToString()) > 0)
                    {
                        lSQL = "insert into gl_trandtl ( ";
                        // Middle Pottion
                        lSQL += " doc_vt_id ";                                                               // Form 1- 
                        ...
                        //                                                                                       // 5- Ac Title NA
                        lSQL += ", '" + StrF01.EnEpos(grdWaste.Rows[dGVRow].Cells[(int)GColWasteMill.ItemName].Value.ToString())
                             + " Qty: " + StrF01.EnEpos(grdWaste.Rows[dGVRow].Cells[(int)GColWasteMill.Qty].Value.ToString())
                            + "@" + String.Format("{0:0,0.00}", grdWaste.Rows[dGVRow].Cells[(int)GColWasteMill.Rate].Value)
                            + "'";      // 8- Narration 
                        //+ "@" + String.Format("{0:0,0.00}", StrF01.EnEpos(grdVoucher.Rows[dGVRow].Cells[(int)GColMfg.LabRate].Value.ToString()))
                        //String.Format("{0:0,0.00}", fLabChges);
                        lSQL += ", " + grdWaste.Rows[dGVRow].Cells[(int)GColWasteMill.Amount].Value.ToString();           // 9- Debit. 
                        lSQL += ", 0";          // 10- Debit. 
                        lSQL += ", " + dGVRow.ToString();          // 11- Serial No
                        lSQL += ", 0"; //is Checked
                        lSQL += ")";
                        ...
                        //                                                                                       // 5- Ac Title NA
                        lSQL += ", '" + StrF01.EnEpos(grdWaste.Rows[dGVRow].Cells[(int)GColWasteMill.ItemName].Value.ToString())       // 8- Narration 
                            + " Qty: " + StrF01.EnEpos(grdWaste.Rows[dGVRow].Cells[(int)GColWasteMill.Qty].Value.ToString())
                            + "@" + String.Format("{0:0,0.00}", grdWaste.Rows[dGVRow].Cells[(int)GColWasteMill.Rate].Value)
                            //+ "@" + String.Format("{0:0,0.00}", StrF01.EnEpos(grdVoucher.Rows[dGVRow].Cells[(int)GColMfg.LabRate].Value.ToString()))
                            + "'";      // 8- Narration 
                        lSQL += ", 0";           // 9- Debit. 
                        lSQL += ", " + grdWaste.Rows[dGVRow].Cells[(int)GColWasteMill.Amount].Value.ToString();          // 10- Debit. 
                        lSQL += ", " + dGVRow.ToString();          // 11- Serial No
                        lSQL += ", 0"; //is Checked
                        lSQL += ")";
                        //
                ...
                {
                    // Mesh Transaction
                    if (clsDbManager.ConvDecimal(grdVoucher.Rows[dGVRow].Cells[(int)GColMill.Amount].Value.ToString()) > 0)
                    {
                        lSQL = "insert into gl_trandtl ( ";
                        // Middle Pottion
                        lSQL += " doc_vt_id ";                                                               // Form 1- 
                        ...
                        lSQL += ", " + msk_AccountIDDr.Tag;                     // 2- Serial Order replaced with SNo. 
                        //                                                                                       // 5- Ac Title NA
                        lSQL += ", 'Mesh: " + StrF01.EnEpos(grdVoucher.Rows[dGVRow].Cells[(int)GColMill.ItemName].Value.ToString())       // 8- Narration 
                            +" Qty: " + StrF01.EnEpos(grdVoucher.Rows[dGVRow].Cells[(int)GColMill.MeshTotal].Value.ToString())
                            + "@" + String.Format("{0:0,0.00}", grdVoucher.Rows[dGVRow].Cells[(int)GColMill.MeshRate].Value)
                            //+ "@" + String.Format("{0:0,0.00}", StrF01.EnEpos(grdVoucher.Rows[dGVRow].Cells[(int)GColMfg.MeshRate].Value.ToString()))
                            + "'";      // 8- Narration 

                        lSQL += ", " + grdVoucher.Rows[dGVRow].Cells[(int)GColMill.Amount].Value.ToString();           // 9- Debit. 
                        lSQL += ", 0";          // 10- Debit. 
                        lSQL += ", " + dGVRow.ToString();          // 11- Serial No
                        lSQL += ", 0"; //is Checked
                        lSQL += ")";
                        ...
                        lSQL += ", 0";           // 9- Debit. 
                        lSQL += ", " + grdVoucher.Rows[dGVRow].Cells[(int)GColMill.Amount].Value.ToString();          // 10- Debit. 
                        lSQL += ", " + dGVRow.ToString();          // 11- Serial No
                        lSQL += ", 0"; //is Checked
                        lSQL += ")";
                        //
        ...
        private int GridTNOT(DataGridView pdGv)
        {
            ...
            try
            {
                ...
                for (int dGVRow = 0; dGVRow < pdGv.Rows.Count; dGVRow++)
                {
                    ...
                    // Prepare Save Data to Db Table
                    //
                    if (pdGv.Rows[dGVRow].Cells[(int)GColMill.ItemID].Value == null)
                    {
                        if (dGVRow == fLastRow)
                        {
                            break;
                    ...
                    {
                        if ((pdGv.Rows[dGVRow].Cells[(int)GColMill.ItemID].Value.ToString()).Trim(' ', '-') == "")
                        {
                            //lBlank = true;
                            if (dGVRow == fLastRow)
                            {
        ...
        private void grdWaste_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Space)
            {
                ...
                if (grdWaste.Rows.Count > 0)
                {
                    ...
                    txtItemID.Text = grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.ItemID].Value.ToString();
                    lblItemName.Text = grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.ItemName].Value.ToString();
                    cbo_UOM.SelectedIndex = clsSetCombo.Set_ComboBox(cbo_UOM, int.Parse(grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.UOMID].Value.ToString()));
                    cboGodown.SelectedIndex = clsSetCombo.Set_ComboBox(cboGodown, int.Parse(grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.GodownID].Value.ToString()));

                    txtQty.Text = grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.Qty].Value.ToString();
                    txtRate.Text = grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.Rate].Value.ToString();
                    txtBundle.Text = grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.Bundle].Value.ToString();
                    lblTotalMeasure.Text = grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.MeshTotal].Value.ToString();
                    lblAmount.Text = grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.Amount].Value.ToString();
                    txtLength.Text = grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.Length].Value.ToString();
                    txtLenDec.Text = grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.LenDec].Value.ToString();
                    txtWidth.Text = grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.Width].Value.ToString();
                    txtWidDec.Text = grdWaste.Rows[fEditRow].Cells[(int)GColWasteMill.WidDec].Value.ToString();
