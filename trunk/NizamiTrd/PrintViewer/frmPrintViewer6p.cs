...
namespace NizamiTrd.PrintViewer6p
{
    public partial class frmPrintViewer6p : Form
    {
        ...
        public frmPrintViewer6p(string fRptTitle, string p, string p_2, string p_3, string p_4, string p_5, string p_6, string p_7, string plstField, string plstType, string plstValue, dsAgingDueRep ds_2, CrAgingDueRep rpt1_2, string p_8)
        {
        ...
        private void ExecuteSPData()
        {
            ...
            try
            {
                ...
                //
    //---------------------***********
    // When Report Run Very Slow then the following Code is Important -- Begin
    //---------------------***********
    ...
    //---------------------***********
    // When Report Run Very Slow then the following Code is Important --End
    //---------------------***********
