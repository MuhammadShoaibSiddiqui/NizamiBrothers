...
using NizamiTrd.Temp;

namespace NizamiTrd.PrintViewer
{
    public partial class frmPrintViewer : Form
    {
        ...
        public frmPrintViewer(string fRptTitle, string fOptionalTitle1, string fOptionalTitle2, string fSelectedSp, string fListField, string fListSQLType, string fListValue, dsLedger ds, CrTrial rptName, string p)
        {
        ...
        public frmPrintViewer(string fRptTitle, string fOptionalTitle1, string fOptionalTitle2, string fSelectedSp, string fListField, string fListSQLType, string fListValue, dsLedger ds, CrTrialOp rptName_2, string p)
        {
            // TODO: Complete member initialization
            this.fRptTitle = fRptTitle;
            this.fOptionalTitle1 = fOptionalTitle1;
        ...
        public frmPrintViewer(string fRptTitle, string fOptionalTitle1, string fOptionalTitle2, string fSelectedSp, string fListField, string fListSQLType, string fListValue, dsLedger ds, CrLedger rptName_3, string p)
        {
            // TODO: Complete member initialization
            this.fRptTitle = fRptTitle;
            this.fOptionalTitle1 = fOptionalTitle1;
