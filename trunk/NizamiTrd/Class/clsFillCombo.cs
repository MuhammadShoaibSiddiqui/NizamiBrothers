...
namespace NizamiTrd
{
    ...
    public class clsFillCombo
   {
     ...
     public static void ACheckedListBox(
         ...
         )  // Add Display Member, Value Member, Also set Default value
     {
        ...
        )  // Add Display Member, Value Member, Also set Default value
    {
        ...
        try
        {
            ...
            // Extra Empty Field For Report Purpose
            if (boolEmptyField == true)
            {
                cbo.DisplayMember = " <<All>>";
                cbo.ValueMember = "0";
            }
